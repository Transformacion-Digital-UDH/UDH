<template>
    <div
        class="bg-white relative py-2 z-[1] before:bg-[#333333] before:absolute before:w-[70%] before:h-full before:top-0 before:left-0 before:rounded-tr-full after:bg-green-custom after:absolute after:w-[30%] after:h-full after:top-0 after:right-0 after:rounded-bl-full">
        <div class="container px-[-4px] mx-4 lg:mx-auto lg:px-4">
            <!-- wrapper header -->
            <div class="flex items-center justify-between">
                <!-- left -->
                <div class="mr-2 z-10 text-white flex gap-6 text-sm lg:text-base font-epilogue">
