...
// Montar los datos al cargar el componente
onMounted(() => {
    fetchContactData();
});
</script>
                ...
                <div class="">
                    ...
                    <div class="my-6">
                        ...
                        <div v-for="(contacto, index) in contactos" :key="index">
                            <template v-if="contacto.direccion === 'Jr. Hermilio Valdizán # 871 - Huánuco'">
                                <!-- Celular -->
                                <a v-if="contacto.celular" href="#"
                                ...
                                <!-- Dirección -->
                                <a v-if="contacto.direccion" href="#"
                                    class="flex my-3 gap-5 items-center content-center">
                                    <div class="items-center content-center bg-green-custom p-1 rounded-md">
                                        <IconMapPin size="20" />
                                    </div>
                                ...
                                <!-- Email -->
                                <a v-if="contacto.correo_electronico" href="#"
                                    class="flex my-3 gap-5 items-center content-center">
                                    <div class="items-center content-center bg-green-custom p-1 rounded-md">
                                        <IconMail size="20" />
                                    </div>
                    ...
                    <div class="my-6">
                        ...
                        <div v-for="(contacto, index) in contactos" :key="index">
                            <template v-if="contacto.direccion === 'Carretera Central km 2.6 - Huánuco'">
                                <!-- Celular -->
                                <a v-if="contacto.celular" href="#"
                                    class="flex my-3 gap-5 items-center content-center">
                                    <div class="items-center content-center bg-green-custom p-1 rounded-md">
                ...
                <div
                    ...
                    <div class="mt-7">
                        <p>
                            ...
                            las últimas noticias de la universidad y sus servicios.
                        </p>
