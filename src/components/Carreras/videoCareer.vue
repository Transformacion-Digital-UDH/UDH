...
const fecthSystemVideo = async () => {
  try {
    ...
    videosistemas.value = response.videosistemas || {};
  } catch (error) {
  ...
  <div class="about-area py-16 bg-white flex justify-center">
    <div class="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center">
      <div class="about-area py-16 bg-white">
        <div class="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center">
          <div class="relative">
            <ImageWithFrames imageUrl="https://placehold.co/600x400"
            ...
            <button class="play-button absolute flex items-center justify-center z-20" @click="openVideo">
